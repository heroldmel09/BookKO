(function ($) {
    ...
    var slide = function (ele, options) {
        ...
        var states = [
            { $zIndex: 1, width: 670, height: 260, top: 69, left: 134, $opacity: 0.2 },
            { $zIndex: 2, width: 680, height: 370, top: 59, left: 0, $opacity: 0.4 },
            { $zIndex: 3, width: 720, height: 418, top: 35, left: 110, $opacity: 0.7 },
            { $zIndex: 4, width: 774, height: 488, top: 0, left: 263, $opacity: 1 },
            { $zIndex: 3, width: 720, height: 418, top: 35, left: 470, $opacity: 0.7 },
            { $zIndex: 2, width: 680, height: 370, top: 59, left: 620, $opacity: 0.4 },
            { $zIndex: 1, width: 670, height: 260, top: 69, left: 500, $opacity: 0.2 }
        ];

        var $lis = $ele.find('.content');
        var timer = null;
